...
const Reports = () => {
  ...
  const totalReturns = returns.reduce((s, t) => s + Math.abs(t.total), 0);
  const profit = totalSales - totalPurchase - totalReturns;
      ...
      <main className="p-12 lg:p-16 max-w-6xl mx-auto">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
          {[
            ...
            { label: "Procurement", val: totalPurchase, color: "text-slate-500" },
            { label: "Returns", val: totalReturns, color: "text-red-400" },
